		...
		<div class="col-xs-12 bb-gray py-20">
			...
			<?php
				...
				if (ComponentHelper::getComponent('com_cluster', true)->enabled)
				{
					...
					JLoader::register('TjfieldsTableField', JPATH_ADMINISTRATOR . '/components/com_tjfields/tables/field.php');
					$fieldTable = new TjfieldsTableField(Factory::getDbo());
							...
							<tr>
								...
								foreach ($columnsToShow as $fieldId => $col_name)
								{
									...
									else
									{
										...
										JLoader::register('TjfieldsTableField', JPATH_ROOT . '/administrator/components/com_tjfields/tables/field.php');
										$tjFieldsFieldTable = new TjfieldsTableField(Factory::getDbo());
