...
JLoader::register('TjucmModelItemForm', JPATH_SITE . '/components/com_tjucm/models/itemform.php');
$tjucmItemFormModel = new TjucmModelItemForm(array('ignore_request' => true));
...
if ($ucmType)
{
	...
	JLoader::register('TjucmTableType', JPATH_ADMINISTRATOR . '/components/com_tjucm/tables/type.php');
	$ucmTypeTable = new TjucmTableType(Factory::getDbo());
...
JLoader::import('components.com_tjucm.models.itemform', JPATH_SITE);
$itemFormModel = new TjucmModelItemForm(array('ignore_request' => true));
