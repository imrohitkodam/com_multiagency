...
class MultiagencyModelLicenceForm extends FormModel
{
	...
	protected function populateState()
	{
		...
		*/
		...
		$id = $app->getInput()->getInt('id') ? $app->getInput()->getInt('id') : $app->getUserState('com_multiagency.edit.licence.id');
	...
	public function save($data)
	{
		...
		*/
		...
		{
			Factory::getApplication()->enqueueMessage($triggerResult[0], 'error');
	...
	public function validate($form, $data, $group = null)
	{
		if (!$data['multiyearlicence'])
		{
			...
			{
				Factory::getApplication()->enqueueMessage(Text::_('COM_MULTIAGENCY_LICENCES_START_END_DATE_WARNING'), 'error');
		...
		else
		{
			...
			{
				Factory::getApplication()->enqueueMessage(Text::_('COM_MULTIAGENCY_LICENCES_START_CURRENT_DATE_BIGGER_WARNING'), 'error');
			...
			*/
			...
			{
				Factory::getApplication()->enqueueMessage(Text::_('COM_MULTIAGENCY_LICENCES_END_CURRENT_DATE_BIGGER_WARNING'), 'error');
