...
// Check if com_tjfields component exists before requiring its files
if (file_exists(JPATH_SITE . "/components/com_tjfields/filterFields.php"))
{
	require_once JPATH_SITE . "/components/com_tjfields/filterFields.php";
}

// TJQueue component loading disabled due to compatibility issues with Joomla 4+
// The component will work without queue functionality
/*
if (ComponentHelper::getComponent('com_tjqueue', true)->enabled)
{
	$tjqueueLibPath = JPATH_SITE . '/administrator/components/com_tjqueue/libraries/tjqueueproduce.php';
	
	if (file_exists($tjqueueLibPath))
	{
...
class TjucmModelItemForm extends AdminModel
{
	...
	// Use imported Trait in model - only if com_tjfields is available
	// Commented out due to missing com_tjfields component
