...
class TjucmViewItemform extends HtmlView
{
	...
	public function display($tpl = null)
	{
		...
		// Check if com_cluster component exists before using it
		if (file_exists(JPATH_ADMINISTRATOR . '/components/com_cluster/includes/cluster.php'))
		{
