...
// Check if com_jlike component exists before loading
...
class PlgContentjlike_Dpe extends CMSPlugin
{
	...
	{
		// Check if com_jlike component exists
		if (ComponentHelper::isEnabled('com_jlike'))
		{
	...
	public function onContentAfterDisplay($context, &$entity, &$params, $page = 0, $url = null)
	{
		...
		{
			$app = Factory::getApplication();
			$formId = $app->getInput()->getInt('content_id', 0);
		}
