...
if (!class_exists('DpeHelix3'))
{
    require_once (__DIR__ . '/core/dpehelix3.php');
}

class  plgSystemDpehelix3 extends CMSPlugin
{
	...
	public function onAfterInitialise()
	{
        ...
        {
            $bootstrapPath = JPATH_ROOT . '/plugins/system/dpehelix3/html/layouts/libraries/cms/html/bootstrap.php';

            if (Factory::getApplication()->isClient('site') && \file_exists($bootstrapPath))
            {
                if (!class_exists('DpeHelix3Bootstrap'))
                {
                    require_once $bootstrapPath;
                }


               HTMLHelper::register('bootstrap.startTabSet', ['DpeHelix3Bootstrap', 'startTabSet']);
               HTMLHelper::register('bootstrap.addTab', ['DpeHelix3Bootstrap', 'addTab']);
            }
        }
	}
