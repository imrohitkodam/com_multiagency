...
class TjucmModelType extends AdminModel
{
	...
	public function save($data)
	{
		...
		// Check if table instance was created successfully
		if ($tjfieldsFieldTable === false)
		{
			// TjFields component may not be installed or table class not found
			// Skip subform field creation
