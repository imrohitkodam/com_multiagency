...
class TjucmViewTypes extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title($component_title . " : " . Text::_('COM_TJUCM_TITLE_TYPES'), 'list');
		...
		if (file_exists($formPath))
		{
			...
			{
				ToolbarHelper::addNew('type.add', 'JTOOLBAR_NEW');
			}

			if ($canDo->get('core.edit') && isset($this->items[0]))
			{
				ToolbarHelper::editList('type.edit', 'JTOOLBAR_EDIT');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			if (isset($this->items[0]->state))
			{
				...
				ToolbarHelper::custom('types.publish', 'publish.png', 'publish_f2.png', 'JTOOLBAR_PUBLISH', true);
				ToolbarHelper::custom('types.unpublish', 'unpublish.png', 'unpublish_f2.png', 'JTOOLBAR_UNPUBLISH', true);
			}
			elseif (isset($this->items[0]))
			{
				// If this component does not use state then show a direct delete button as we can not trash
				ToolbarHelper::deleteList('', 'types.delete', 'JTOOLBAR_DELETE');
			}
		}
		...
		if (isset($this->items[0]->state))
		{
			...
			{
				ToolbarHelper::deleteList('', 'types.delete', 'JTOOLBAR_EMPTY_TRASH');
				ToolbarHelper::divider();
			}
			elseif ($canDo->get('core.edit.state'))
			{
				ToolbarHelper::trash('types.trash', 'JTOOLBAR_TRASH');
				ToolbarHelper::divider();
			}
		}
		...
		{
			ToolbarHelper::custom('types.export', 'download', '', 'COM_TJUCM_TYPE_EXPORT', false);
