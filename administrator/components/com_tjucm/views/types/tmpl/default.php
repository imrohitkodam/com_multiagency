...
// Chosen was removed in Joomla 4+ - using native select or choicesjs if needed
			...
			<div class="tjBs3">
				<div class="btn-group pull-left">
					<div class="filter-search btn-group pull-left">
						...
						<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo Text::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="hasTooltip" title="<?php echo HTMLHelper::tooltipText('COM_TJUCM_SEARCH_IN_TITLE'); ?>" />
					</div>
					<div class="btn-group pull-left">
						...
						<button type="button" class="btn hasTooltip" id="clear-search-button" title="<?php echo HTMLHelper::tooltipText('JSEARCH_FILTER_CLEAR'); ?>"><i class="icon-remove"></i></button>
					</div>
				</div>
