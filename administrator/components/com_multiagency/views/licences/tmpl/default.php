...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_multiagency&task=licences.saveOrderAjax&tmpl=component';
	HTMLHelper::_('sortablelist.sortable', 'licenceList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo Route::_('index.php?option=com_multiagency&view=licences'); ?>" method="post"
			...
			<table class="table table-striped" id="licenceList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_MULTIAGENCY_LICENCES_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_MULTIAGENCY_LICENCES_COURSE_ID', 'a.`course_id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_MULTIAGENCY_LICENCES_TOTAL_SEATS', 'a.`total_seats`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_MULTIAGENCY_LICENCES_USED_SEATS', 'a.`used_seats`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_MULTIAGENCY_LICENCES_START_DATE', 'a.`start_date`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_MULTIAGENCY_LICENCES_END_DATE', 'a.`end_date`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'licences.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
