...
class SubusersAction
{
	...
	public function save()
	{
		...
		unset($properties['actionObj']);
		unset($properties['errorMessage']);
		...
		try
		{
			...
			if (!$table->check())
			{
				$this->errorMessage = 'Table check failed';
			...
			if (!($table->store()))
			{
				$this->errorMessage = 'Table store failed';
	...
	public function bind(&$array)
	{
		if (empty($array))
		{
			$this->errorMessage = Text::_('COM_SUBUSER_EMPTY_DATA');
