...
class MultiagencyModelMultiagencyForm extends FormModel
{
	...
	public function validate($form, $data, $group = null)
	{
		...
		if ($agencyValidate)
		{
			Factory::getApplication()->enqueueMessage(Text::_('COM_MULTIAGENCY_TITLE_MESSAGE'), 'error');
	...
	public function delete($pk)
	{
		...
		{
			Factory::getApplication()->enqueueMessage(Text::_("COM_MULTIAGENCY_ITEM_DOESNT_EXIST"), 'error');
		...
		{
			Factory::getApplication()->enqueueMessage(Text::_("JERROR_FAILED"), 'error');
